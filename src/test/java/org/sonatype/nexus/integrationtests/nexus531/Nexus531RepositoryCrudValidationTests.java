    ...
    extends AbstractPrivilegeTest
{
        ...
        throws IOException
    {
        ...
        Assert.assertFalse( response.getStatus().isSuccess(), "Repo should not have been created: "
            + response.getStatus() + "\n" + responseText );
        Assert.assertTrue(
            responseText.contains( "<errors>" ),
            "Response text did not contain an error message. \nResponse Text:\n " + responseText );
        ...
        throws IOException
    {
        ...
        Assert.assertTrue( response.getStatus().isSuccess(), "Expected name to default." + responseText );
        Assert.assertTrue( this.messageUtil.getRepository( "createNoNameTestnull" ).getName().equals(
            "createNoNameTestnull" ), "Expected name to default to id" );
        ...
        throws IOException
    {
        ...
        Assert.assertFalse(
            ...
            response.getStatus().isSuccess(),"Repo should not have been created: " + response.getStatus() + "\n" + responseText );
        Assert.assertTrue(
            
            responseText.contains( "<errors>" ), "Response text did not contain an error message. \nResponse Text:\n " + responseText );
    }
        ...
        throws IOException
    {
        ...
        Assert.assertTrue( response
            .getStatus().isSuccess(), "Expected DefaultLocalStorageUrl to be ignored on create" + responseText );
    }
        ...
        throws IOException
    {
        ...
        if ( !this.printKnownErrorButDoNotFail( this.getClass(), "updateValidatioinTest" ) )
        {
            ...
            Assert.assertFalse(
                ...
                response.getStatus().isSuccess(), "Repo should not have been updated: " + response.getStatus() + "\n" + responseText );
            Assert.assertTrue( responseText.contains( "<errors>" ), "Response text did not contain an error message. Status: " + response.getStatus()
                + "\nResponse Text:\n " + responseText );
            resource.setId( "updateValidatioinTest" );
