    ...
    extends AbstractPrivilegeTest
{
        ...
        throws Exception
    {
        ...
        Assert.assertTrue(
            feedListContainsArtifact( entries, "nexus779", "test1", "1.0.0" ),
            "Feed should contain entry for nexus779:test1:1.0.0.\nEntries: " + this.entriesToString( entries ) );

        Assert.assertTrue(
            feedListContainsArtifact( entries, "nexus779", "test2", "1.0.0" ),
        ...
        Assert.assertFalse(
            feedListContainsArtifact( entries, "nexus779", "test2", "1.0.0" ),
            "Feed should not contain entry for nexus779:test2:1.0.0\nEntries: " + this.entriesToString( entries ) );
        ...
        Assert.assertFalse(
            feedListContainsArtifact( entries, "nexus779", "test1", "1.0.0" ),
            "Feed should not contain entry for nexus779:test1:1.0.0.\nEntries: " + this.entriesToString( entries ) );
