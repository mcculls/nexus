...
public class Nexus1560LegacyAllowRulesTest
    extends AbstractLegacyRulesTest
{
        ...
        throws Exception
    {
        ...
        addPriv( TEST_USER_NAME, REPO_TEST_HARNESS_REPO + "-priv", "repositoryTarget", "1", REPO_TEST_HARNESS_REPO,
                 null, "read" );
    }
    ...
    public void fromRepository()
        throws Exception
    {
        String downloadUrl = REPOSITORY_RELATIVE_URL + REPO_TEST_HARNESS_REPO + "/" + getRelitiveArtifactPath( gavArtifact1 );
    ...
    public void artifact2FromGroup()
        throws Exception
    {
        String downloadUrl = GROUP_REPOSITORY_RELATIVE_URL + NEXUS1560_GROUP + "/" + getRelitiveArtifactPath( gavArtifact2 );
    ...
    throws Exception
    {
        String downloadUrl = REPOSITORY_RELATIVE_URL + REPO_TEST_HARNESS_REPO + "/" + getRelitiveArtifactPath( gavArtifact2 );
    ...
    throws Exception
    {
        String downloadUrl = REPOSITORY_RELATIVE_URL + REPO_TEST_HARNESS_REPO2 + "/" + getRelitiveArtifactPath( gavArtifact2 );
